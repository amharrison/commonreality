 ...
 */
package org.commonreality.message.command;
...
/**
 * a message that is a command from reality. These will only ever come from the
 * reality participant and be sent to agents and sensors
 * 
 * @author developer
 */
