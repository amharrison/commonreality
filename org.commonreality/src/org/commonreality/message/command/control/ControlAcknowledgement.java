    ...
    implements IControlAcknowledgement
{
  ...
  static private final Log LOGGER = LogFactory
                                      .getLog(ControlAcknowledgement.class);
  ...
  /**
   * @see org.commonreality.message.command.control.IControlAcknowledgement#getException()
   */
  ...
  /**
   * @see org.commonreality.message.command.control.IControlAcknowledgement#getState()
   */
