    ...
    Serializable
{
  ...
  /**
   * @see org.commonreality.message.command.object.IObjectCommand#getIdentifiers()
   */
  ...
  /**
   * @see org.commonreality.message.command.object.IObjectCommand#getType()
   */
  public Type getType()
  {
    return _type;
